...
if len(sys.argv) >= 2 and sys.argv[1] == "-i" and __name__ == "__main__": 
    #Print this message if you load from interactive sage.
    print("""
***************************************************************************
...
load_data("filename") to retrieve previously saved data.  The default filename 
...
def space(g, n, namespace = None, print_classes = True):
    ...
    if namespace == None and __name__ == "__main__":
        namespace = globals()
    current_space = Mgn(g, n, namespace)
